...
if [ ! -d ~/dios/device/generic/goldfish/64bitonly/product ]; then
    mkdir -p ~/dios/device/generic/goldfish/64bitonly/product
fi

echo ""
echo "D!OS VENDOR MK..."
echo ""
if [ ! -d ~/dios/backups/device/generic/goldfish/64bitonly/product ]; then
     mkdir -p ~/dios/backups/device/generic/goldfish/64bitonly/product
fi
cp -fnrp ~/dios/device/generic/goldfish/64bitonly/product/vendor.mk ~/dios/backups/device/generic/goldfish/64bitonly/product
cat <<\EOF >~/dios/device/generic/goldfish/64bitonly/product/vendor.mk
# --------------------------------------------------------------------------------------------------
# Copyright © 2022 Marius Kopp
# --------------------------------------------------------------------------------------------------
include $(CLEAR_VARS)

...
$(shell cp -rf $(LOCAL_PATH)/dios/vendor/* `pwd`/$(TARGET_OUT_VENDOR)/etc)
$(shell cp -rf $(LOCAL_PATH)/fork/pixel/product/etc/* `pwd`/$(TARGET_OUT_PRODUCT)/etc)
$(shell cp -rf $(LOCAL_PATH)/fork/pixel/system_ext/etc/* `pwd`/$(TARGET_OUT_SYSTEM_EXT)/etc)

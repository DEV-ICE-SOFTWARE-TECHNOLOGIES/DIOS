...
if [ ! -d $FORK_DIR ]; then
    ...
    rm -rf $FORK_DIR/product/overlay/SettingsGoogleOverlayCoral.apk || true
    rm -rf $FORK_DIR/product/overlay/SettingsOverlayG020J.apk || true
    rm -rf $FORK_DIR/product/overlay/SettingsOverlayG020P.apk || true
    rm -rf $FORK_DIR/product/overlay/SettingsOverlayG020Q.apk || true
